<template>
    <div>
        ...
        <div class="container">
            ...
            <tr>
                <td>身份证号码：</td>
                <td><input type="text" placeholder="请输入你的身份证号码"></td>
            </tr>
            <tr>
                <td>选择省：</td>
                <td>
            ...
            <tr>
                <td>街道地址：</td>
                <td><input type="text" placeholder="请输入详细地址"></td>
            </tr>
            <div class="setting" @click="isShow=!isShow">
                <span :class="{off:isShow}"></span><span>设定为默认收货地址</span>
            </div>
            <div class="tips">
                <h1>请填写真实身份证号码</h1>
                <p>1.海关需对海外购物查验身份信息，错误信息可能导致无法正常通关。</p>
                <p>2.身份证信息将加密报关，KSCB将保证您的信息安全。</p>
            </div>
...
<style lang="less" scoped>
    ...
    .container {
        ...
        .tips {
            ...
            padding: 0.2666rem 0.266rem 0.4rem;
