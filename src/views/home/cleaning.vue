<template>
    <div>
        <div class="content">
            ...
            <div class="middle">
                <ul class="middle_top">
                    <li><a href=""><img src="./../../assets/images/download-89.jpg" alt=""></a></li>
                    <li><a href=""><img src="./../../assets/images/download-90.jpg" alt=""></a></li>
                </ul>
                <ul class="middle_bottom">
                    <li><a href=""><img src="./../../assets/images/download-91.jpg" alt=""></a></li>
                    <li><a href=""><img src="./../../assets/images/download-92.jpg" alt=""></a></li>
                    <li><a href=""><img src="./../../assets/images/download-93.jpg" alt=""></a></li>
                </ul>
            </div>
            <div class="bottom">
                ...
                <ul class="bottom_bottom">
                    <template v-for="v in 5">
                        <li>
                            <a href="">
                                <img src="./../../assets/images/download-94.jpg" alt="">
                                <span class="name">可调式十字婴儿洗澡浴网#粉色</span>
                                <span class="prices">￥<span>26</span><span>.00</span>+<span>12韩豆</span></span>
                                <span class="people_buy">2人购买</span>
                            </a>
                        </li>
                        <li class="even">
                            <a href="">
                                <img src="./../../assets/images/download-95.jpg" alt="">
                                <span class="name">十字婴儿洗澡浴网#浅蓝色</span>
                                <span class="prices">￥<span>23</span><span>.00</span>+<span>15韩豆</span></span>
                                <span class="people_buy">2人购买</span>
                            </a>
                        </li>
                    </template>
